...
# 1. Your program should repeat
# the behavior from the previous
# stage, but now in a loop.
# 2. Do not forget to include an
# exit opportunity: inputting
# exit should end the program.
# 3. When the program is done
...
while input_number != "exit":
   print(animals[int(input_number)])
   input_number = input()
